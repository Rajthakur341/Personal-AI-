...
engine = pyttsx3.init()
 ...
 #st.set_page_config(page_title="VisionaryIQ", layout="wide", page_icon="👁‍🗨")
st.markdown(
    """
    <style>
     .main-title {
...
st.markdown('<div class="main-title"> Personal AI </div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle"> ✯ An AI Solution for Visually Impaired ✯ </div>', unsafe_allow_html=True)
...
st.sidebar.markdown(
    """
     **Features**
    -  **Describe Scene**: Get a detail description about image.
    -  **Extract Text**: OCR is used to extract the text from image.
    -  **Text-to-Speech**: AI is used to read the text.
...
st.markdown(
    ...
    <footer style="text-align:left;">
        <p>Powered by <strong>Google Gemini API </strong> | Raj Thakur </p>
    </footer>
    """,
    unsafe_allow_html=True,
)
...
st.sidebar.markdown(
    ...
    <hr>
    <footer style="text-align:left;">
        <p>Powered by <strong>Google Gemini </strong> | by Raj Thakur Thank for Watching :D </p>
    </footer>
    """,
    unsafe_allow_html=True,
)
